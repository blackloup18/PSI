...
$.FromOpenNoBtnTitile = function (id, url, width, height, Zindex) {
    top.layer.open({
        id: id,
        type: 2,
        title: false,
...
$.currentWindow = function () {
    var iframeId = top.$(".layuimini-main").find("iframe").attr("id");
