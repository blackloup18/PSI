    ...
    layuimini = new function () {
            ...
            $.each(data, function (key, val) {
                ...
                $.each(menuList, function (index, menu) {
                    ...
                    if (menu.child != undefined && menu.child != []) {
                        ...
                        var buildChildHtml = function (html, child, menuParameId) {
                            ...
                            $.each(child, function (childIndex, childMenu) {
                                ...
                                if (childMenu.child != undefined && childMenu.child != []) {
                                    ...
                                    html += '<a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"  data-tab-mpi="" data-tab="' + childMenu.href + '" target="' + childMenu.target + '"><i class="' + childMenu.icon + '"></i><span class="layui-left-nav"> ' + childMenu.title + '</span></a>\n';
                                    menuParameId++;
                        ...
                        leftMenuHtml += '<a href="javascript:;" class="layui-menu-tips"  data-type="tabAdd" data-tab-mpi="" data-tab="' + menu.href + '" target="' + menu.target + '"><i class="' + menu.icon + '"></i><span class="layui-left-nav"> ' + menu.title + '</span></a>\n';
                        menuParameId++;
                    }
                    leftMenuHtml += '</li>\n';
                });
        ...
        this.bgColorConfig = function (bgcolorId) {
            var bgColorConfig = [
				...
				{
                    headerRight: '#fff',
                    headerRightThis: '#2d3037',
                    headerLogo: '#fff',
                    menuLeft: '#2d3037',
                    menuLeftThis: '#454e57',
                    menuLeftHover: '#454e57',
                }
            ];
