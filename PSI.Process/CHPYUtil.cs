...
namespace PSI.Process
{
    ...
    "Zhuang","Zhui","Zhun","Zhuo","Zi","Zong","Zou","Zu","Zuan","Zui","Zun","Zuo"
        ...
        /// <param name="hz"></param>
        /// <returns></returns>
        public static string GetShortPinyin(string hz)
        {
       ...
       ///// <returns></returns>
       // public static string GetPinyin(string str)//获取拼音（全拼）
       //{
       ...
       ///// <param name="str"></param>
       ///// <returns></returns>
       //public static string GetShortPinyin(string str)//获取拼音（首字母）
       //{
       //    string r = string.Empty;
       //    foreach (char obj in str)
       //    {
